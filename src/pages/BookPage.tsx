...
export default function BookPage() {
  ...
  if (loading)
    return (
      <div className="min-h-screen flex items-center justify-center font-handwritten text-xl text-gray-500">
        Loading...
      </div>
    );
  if (notFound)
    return (
      <div className="min-h-screen flex items-center justify-center font-handwritten text-xl text-red-500">
        Yearbook not found 😕
      </div>
    );
  ...
  return (
    <div className="min-h-screen p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        {/* Main Header */}
        <div
          className="mb-8 text-center cute-container no-print"
          style={{
            maxWidth: "100%",
            padding: "1.5rem",
            marginBottom: "2rem",
        ...
        >
          <h1 className="cute-header" style={{ marginBottom: "0" }}>
            📚 {book!.title}
          </h1>
          <p
          ...
          >
            Share this link:{" "}
            <span
              className="font-mono bg-white px-2 py-1"
              style={{
                borderRadius: "4px",
        ...
        {book!.is_open && (
          <div
            className="mb-10 cute-container no-print"
            style={{ maxWidth: "100%" }}
          >
            <EntryForm
              bookId={book!.id}
              onSubmit={() => loadEntries(book!.id)}
            />
          </div>
        )}
        ...
        {/* Regular View */}
        <div
          className="no-print entries-wrapper export-container"
          ref={exportRef}
        >
          <div className="mb-6">
            <h1
        ...
        >
          ...
          <span className="text-purple-600 font-bold">harshkurware22</span>
        </div>
      </div>
    </div>
  );
